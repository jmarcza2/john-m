...
class NameBar extends Component {
  constructor(props) {
    ...
    const { text1, text2, open, fill1, fill2, mHeight } = this.props;
  ...
  static getDerivedStateFromProps(
    ...
    if (!isEqual([text1, text2], texts))
      return { texts: [text1, text2], scales: [0, 0] };
  ...
  getDefaultStyle = (start, end) =>
    this.state.open && !this.forceClose ? start : end;
  ...
  render() {
    ...
    const offset = (size * this.offset) / 220;
    const height = 116;
            ...
            {({ d, y1, y2 }) => (
              <Fragment>
                <rect
                  ...
                  strokeDasharray={`${Math.max(d, 0)} ${Math.max(
                    boxSize - d,
                    0,
                  )}`}
                ...
                <g clipPath={`url(#clip1-${this.id})`}>
                  ...
                  <text
                    ...
                    fill={this.fill1} // elegant
                    textAnchor="middle"
                    alignmentBaseline="central" // vertical centering in firefox
                    dominantBaseline="central"
                    style={{
                      transform: `translate(${this.center}px, ${y1}px) scale(${
                        scales[0]
                      })`,
                    }}
                  >
                ...
                <g clipPath={`url(#clip2-${this.id})`}>
                  ...
                  <text
                    ...
                    textAnchor="middle"
                    style={{
                      transform: `translate(${this.center}px, ${y2}px) scale(${
                        scales[1]
                      })`,
                    }}
                  >
